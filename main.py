...
keywords = ["source localization","source detection","source identification","Diffusion Source Inference","rumor source"] # TODO add more keywords
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/waityousea/DailyArXiv/) page for a better reading experience and more papers.**\n\n")
